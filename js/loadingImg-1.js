!(function($){
	...
	//有序加载
	// LoadingImg.prototype.orderLoad=function(){
	// 	var count=0, //计数器
	// 		imgs=this.imgs,
	// 		opts=this.opts,
	// 		len=imgs.length;
	...
	//无序加载
	// LoadingImg.prototype.unOrderLoad=function(){
	// 	var count=0, //计数器
	// 		imgs=this.imgs,
	// 		opts=this.opts,
	// 		len=imgs.length;
